...
execute if score UHCEter uhcEnabled matches 1 if score UHC uhcMin = UHC uhcEter run tellraw @a [{"text":""},{"text":"Hunt Zed","color":"light_purple"},{"text":" \u2503 "},{"text":"Eternal day","color":"gray"},{"text":" \u2503 "},{"text":"Activated", "color":"gold"}]
