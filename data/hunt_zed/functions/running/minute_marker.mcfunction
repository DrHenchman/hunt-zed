...
execute if score UHCMM uhcEnabled matches 1 if score UHC uhcMin = UHC uhcNextMM if score UHC uhcMin matches 1.. run tellraw @a [{"text":""},{"text":"Hunt Zed","color":"light_purple"},{"text":" \u2503 "},{"text":"Mark","color":"gray"},{"text":" \u2503 "},{"score":{"name":"Hunt Zed","objective":"uhcNextMM"},"color":"gold"},{"text":" Minutes", "color":"gold"}]
