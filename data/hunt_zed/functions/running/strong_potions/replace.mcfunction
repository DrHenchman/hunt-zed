...
function hunt_zed:running/strong_potions/replace_loop

playsound minecraft:entity.witch.drink player @s[tag=any_strong_potion] ~ ~ ~ 1 0.9
tellraw @s[tag=any_strong_potion] [{"text":""},{"text":"Hunt Zed","color":"light_purple"},{"text":" \u2503 "},{"text":"Strong potions","color":"gray"},{"text":" \u2503 "},{"text":"Disabled","color":"red"}]
tag @s remove any_strong_potion
