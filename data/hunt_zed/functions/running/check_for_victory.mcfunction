...
#execute if score TeamsRemaining uhcState matches 0..1 run tellraw @a[tag=admin] [{"text":""},{"text":"Hunt Zed","color":"light_purple"},{"text":" \u2503 "},{"text":"Victory detected","color":"gray"},{"text":" \u2503 "},{"text":"[Click to complete]","color":"green","clickEvent":{"action":"run_command","value":"/function hunt_zed:complete"}}]
