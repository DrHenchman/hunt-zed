...
execute as @a[team=spectate] run function hunt_zed:running/make_player_spectator
...
# Set Friendly Fire
execute if score UHCFriendlyFire uhcEnabled matches 1 run function hunt_zed:starting/friendlyfire_enable
execute if score UHCFriendlyFire uhcEnabled matches 0 run function hunt_zed:starting/friendlyfire_disable
