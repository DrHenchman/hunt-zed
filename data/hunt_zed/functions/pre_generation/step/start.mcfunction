...
execute as @e[type=minecraft:armor_stand,tag=pre_generator,tag=new,limit=1] run function hunt_zed:pre_generation/step/relocate_marker

function hunt_zed:pre_generation/step/pointer/update
