...
execute if score Stage uhcPG matches 1 run bossbar set hunt_zed:pregen name {"text":"Generating the Overworld...","color":"white"}
...
execute if score Stage uhcPG matches 2 run bossbar set hunt_zed:pregen name {"text":"Generating the Nether...","color":"white"}

execute if score Stage uhcPG matches ..2 run function hunt_zed:pre_generation/stage/start
execute unless score Stage uhcPG matches ..2 run function hunt_zed:pre_generation/complete
